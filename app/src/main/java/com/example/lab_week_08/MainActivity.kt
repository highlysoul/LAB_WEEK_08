...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1. Request for notification permission (required for Android 13/API 33 and above)
        ...
        workManager.getWorkInfoByIdLiveData(secondRequest.id)
            .observe(this) { info ->
                if (info.state.isFinished) {
                    ...
                    // 9. Call launchNotificationService after SecondWorker is done
    ...
    // 8. Launch the NotificationService
    ...
    // 8. Companion object with EXTRA_ID constant
    companion object{
